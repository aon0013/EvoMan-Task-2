...
npop = 50                 # Population size per island
...
mutation_rate_initial = 0.2  # Starting mutation rate
mutation_rate_final = 0.01   # Minimum mutation rate
...
# Individual island evolutionary run with elitism and adaptive mutation
...
if os.path.exists(experiment_name + '/neuroended'):
    ...
    n_hidden_neurons = 10  # Ensure this matches the evolution settings
