...
# Enemies to train on
all_enemies = [2, 4, 6] # change enemies after first part done
...
mutation_rate_initial = 0.3  # Starting mutation rate
mutation_rate_final = 0.05   # Minimum mutation rate
...
# Individual island evolutionary run with elitism, adaptive mutation, and local search
